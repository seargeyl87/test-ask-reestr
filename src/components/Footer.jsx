...
function Footer() {
    return (
        ...
        <div className="develop">
            <i className="img"></i>
            <i>Открытое акционерное общество  «Реестр ПО» начало практическую деятельность с 1 марта 2014 г</i>
            <h4>Разработчик</h4>
            <i>ОАО «Агентство сервисизации и реинжиниринга»</i>
            <i>Минск, улица Клары Цеткин, 24</i>
        </div>
        <div className="info">
          <h3>Информация</h3>
              <ul>
